...
router.get(['/sum/:num1/:num2/:lang', '/sum/:num1/:num2/'], (req, res) => {
  try {
    const data = calc('sum', req.params.lang, req.params.num1, req.params.num2)
...
router.get(['/sub/:num1/:num2', '/sub/:num1/:num2/:lang'], (req, res) => {
  try {
    const data = calc('sub', req.params.lang, req.params.num1, req.params.num2)
    if (data.error !== undefined) {
      res.status(400).set(encoding).end(JSON.stringify(data))
    } else {
      res.set(encoding).end(JSON.stringify(data))
...
router.get(['/mul/:num1/:num2', '/mul/:num1/:num2/:lang'], (req, res) => {
  try {
    const data = calc('mul', req.params.lang, req.params.num1, req.params.num2)
    if (data.error !== undefined) {
      res.status(400).set(encoding).end(JSON.stringify(data))
    } else {
      res.set(encoding).end(JSON.stringify(data))
...
router.get(['/div/:num1/:num2', '/div/:num1/:num2/:lang'], (req, res) => {
  try {
    const data = calc('div', req.params.lang, req.params.num1, req.params.num2)
    if (data.error !== undefined) {
      res.status(400).set(encoding).end(JSON.stringify(data))
    } else {
      res.set(encoding).end(JSON.stringify(data))
...
router.get(['/pow/:num1/:num2', '/pow/:num1/:num2/:lang'], (req, res) => {
  try {
    const data = calc('pow', req.params.lang, req.params.num1, req.params.num2)
    if (data.error !== undefined) {
      res.status(400).set(encoding).end(JSON.stringify(data))
    } else {
      res.set(encoding).end(JSON.stringify(data))
...
router.get(['/log/:num1/:num2', '/log/:num1/:num2/:lang'], (req, res) => {
  try {
    const data = calc('log', req.params.lang, req.params.num1, req.params.num2)
    if (data.error !== undefined) {
      res.status(400).set(encoding).end(JSON.stringify(data))
    } else {
      res.set(encoding).end(JSON.stringify(data))
